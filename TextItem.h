...
public:
	...
	void setTextItem(std::string textString, sf::Vector2f vec2Position, int iSize); 
	// Constructor for displaying a string label and a int value
	void setTextItem(std::string textString, int iValue, sf::Vector2f vec2Position); 
	// Constructor for displaying a string label and a float value
	void setTextItem(std::string textString, float fValue, sf::Vector2f vec2Position); 
